...
public class OpenStreetMapTileProvider implements TileProvider {
    ...
    {
    	String UrlFormat = "http://tile.openstreetmap.org/%d/%d/%d.png";
    ...
    {
    	String PathFormat = "E:/OpenStreetMap/%d/%d/%d.png";
